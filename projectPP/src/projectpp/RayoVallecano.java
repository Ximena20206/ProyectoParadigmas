 ...
 * @author LENOVO
 */
public class RayoVallecano extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public RayoVallecano(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RayoVallecano.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RayoVallecano.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RayoVallecanoClick.png"))); // NOI18N

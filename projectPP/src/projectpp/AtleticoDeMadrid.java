 ...
 * @author LENOVO
 */
public class AtleticoDeMadrid extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public AtleticoDeMadrid(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/Betis.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/Betis.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/BetisClick.png"))); // NOI18N

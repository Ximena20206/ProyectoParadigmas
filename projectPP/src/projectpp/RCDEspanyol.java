 ...
 * @author LENOVO
 */
public class RCDEspanyol extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public RCDEspanyol(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDEspanyol.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDEspanyol.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDEspanyolClick.png"))); // NOI18N

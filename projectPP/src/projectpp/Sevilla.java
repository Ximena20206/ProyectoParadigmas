 ...
 * @author LENOVO
 */
public class Sevilla extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public Sevilla(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/Sevilla.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/Sevilla.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/SevillaClick.png"))); // NOI18N

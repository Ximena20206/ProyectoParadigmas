 ...
 * @author LENOVO
 */
public class RealMadrid extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public RealMadrid(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealMadrid.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealMadrid.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealMadridClick.png"))); // NOI18N

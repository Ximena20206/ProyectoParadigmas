 ...
 * @author LENOVO
 */
public class RealSociedad extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public RealSociedad(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealSociedad.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealSociedad.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RealSociedadClick.png"))); // NOI18N

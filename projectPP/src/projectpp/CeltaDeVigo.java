 ...
 * @author LENOVO
 */
public class CeltaDeVigo extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public CeltaDeVigo(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/CeltaDeVigo.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/CeltaDeVigo.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/CeltaDeVigoClick.png"))); // NOI18N

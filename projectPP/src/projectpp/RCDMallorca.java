 ...
 * @author LENOVO
 */
public class RCDMallorca extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public RCDMallorca(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDMallorca.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDMallorca.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/RCDMallorcaClick.png"))); // NOI18N

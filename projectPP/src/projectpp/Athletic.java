 ...
 * @author LENOVO
 */
public class Athletic extends javax.swing.JPanel {

    private Equipo athletic = new Equipo();
    
    public Athletic(Equipo alaves) {
        initComponents();
        this.athletic.establecernombre(alaves.getNombre());
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/AtleticoMadrid.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/AtleticoMadrid.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/AtelticoMadridCLick.png"))); // NOI18N
    ...
    private void BtnEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEquipoActionPerformed
        Ranking  v2= new Ranking(athletic);
        v2.setVisible(true);

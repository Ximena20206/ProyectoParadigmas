 ...
 * @author LENOVO
 */
public class UDLasPalmas extends javax.swing.JPanel {

    private Equipo a = new Equipo();
    
    public UDLasPalmas(Equipo a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        BtnEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/UDLasPalmas.png"))); // NOI18N
        BtnEquipo.setContentAreaFilled(false);
        BtnEquipo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/UDLasPalmas.png"))); // NOI18N
        BtnEquipo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/BackgroundImages/UDLasPalmasClick.png"))); // NOI18N
